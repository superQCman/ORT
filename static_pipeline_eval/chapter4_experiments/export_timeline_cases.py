...
from chapter4_experiments.chapter4_shared import run_timeline_cases  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Export Chapter 4 timeline cases and critical paths.")
