...
from chapter4_experiments.chapter4_shared import build_figures_catalog  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build the Chapter 4 figure catalog.")
...
def main() -> None:
    args = parse_args()
    result = build_figures_catalog(args.output_root)
