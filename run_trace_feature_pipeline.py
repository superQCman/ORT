...
from train_trace_feature_mlp import parse_hidden_layers, train_trace_feature_model
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build the single-op dataset and train a separate MLP that predicts trace-derived features.",
    )
    parser.add_argument(
        "--output-root",
        default=str(SCRIPT_DIR / "artifacts" / "latest_trace_feature_proxy"),
        help="Root directory for dataset/ and trace_feature_model/ outputs.",
    )
    parser.add_argument(
        "--case-pattern",
    ...
    parser.add_argument("--disable-log-targets", action="store_true")
...
def main() -> None:
    ...
    model_dir = output_root / "trace_feature_model"
    ...
    print(f"trace_feature_model_dir={model_dir}")
